...
if __name__ == "__main__":
    ...
    # feature_models = ["color_moments", "hog", "resnet50_layer3", "resnet50_avgpool", "resnet50_fc", "resnet50_softmax"]
    ...
    data_matrix = createMatrix("resnet50_softmax" + "_feature_descriptor")
    file_path = f"{os.path.join(os.getcwd(), f'data_matrices/data_matrix_resnet50_softmax.csv')}"
    np.savetxt(file_path, data_matrix, delimiter=",")
