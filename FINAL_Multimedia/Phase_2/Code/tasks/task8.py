...
def task8_execution(query_image_data, query_latent_semantics, K, dataset, collection2):
    ...
    rep_keyname = {
    "color_moments":["color_moments_rep_image","color_moments_rep_image_id"],
    "hog":["hog_rep_image","hog_rep_image_id"],
    "resnet50_layer3":["layer3_rep_image","resnet50_layer3_rep_image_id"],
    "resnet50_avgpool":["avgpool_rep_image","resnet50_avgpool_rep_image_id"],
    "resnet50_fc":["fc_rep_image","resnet50_fc_rep_image_id"],
    "resnet_softmax":["resnet50_softmax_rep_image","resnet50_softmax_rep_image_id"]
    }
