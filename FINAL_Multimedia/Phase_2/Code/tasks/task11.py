...
def task11_execution(query_latent_semantics, n, m, l, collection, dataset):
    ...
    if query_latent_semantics != 2 and query_latent_semantics!= None:
    ...
    if query_latent_semantics == None:
        ...
        if query_latent_semantics == 1:
            ...
            print("OOPS!! Enter a valid query latent semantics choice!!")
...
def task11():
    ...
    type_of_input = int(input("Enter 1 for feature model selection and enter 2 for latent space selection: "))
    if type_of_input == 2:
        print("Enter any of the Latent Semantics: \n1. LS1\n2. LS2\n3. LS3\n4. LS4\n")
        query_latent_semantics = int(input("Enter your choice number: "))
    else:
        query_latent_semantics = None
