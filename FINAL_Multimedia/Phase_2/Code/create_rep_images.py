...
def store_representative_images():
    ...
    for label in range(101):
        ...
        for image in label_images:
            ...
            softmax_vector.append(np.ravel(image['resnet50_softmax_feature_descriptor']))
        ...
        mean_softmax = np.mean(softmax_vector, axis=0)
        ...
        closest_image_idx_softmax = pairwise_distances_argmin_min([mean_softmax], softmax_vector, metric='euclidean')[0][0]
        ...
        closest_image_id_softmax = label_images[closest_image_vector_softmax]['image_id']
...
if __name__ == "__main__":
    ...
    collection_name = "phase2trainingdataset_final"
    new_collection = db["labelrepresentativeimages_final"]
